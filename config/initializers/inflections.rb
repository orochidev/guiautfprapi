...
# inflect.irregular 'person', 'people'
# inflect.uncountable %w( fish sheep )
	inflect.irregular 'vinculoempregaticio', 'vinculosempregaticios'
	inflect.irregular 'vinculo_empregaticio', 'vinculos_empregaticios'

	inflect.irregular 'VinculoEmpregaticio', 'VinculosEmpregaticios'

	#Empregador fisico plural
	inflect.irregular 'EmpregadorFisico', 'EmpregadoresFisicos'
	inflect.irregular 'empregador_fisico', 'empregadores_fisicos'
	inflect.irregular 'empregadorfisico', 'empregadoresfisicos'

	#Empregador juridico plural
	inflect.irregular 'EmpregadorJuridico', 'EmpregadoresJuridicos'
	inflect.irregular 'empregador_juridico', 'empregadores_juridicos'
	inflect.irregular 'empregadorjuridico', 'empregadoresjuridicos'


	#Local de trabalho plural
	inflect.irregular 'localdetrabalho', 'locaisdetrabalho'

	inflect.irregular 'LocalDeTrabalho', 'LocaisDeTrabalho'
	inflect.irregular 'local_de_trabalho', 'locais_de_trabalho'


	#Local de trabalho plural
	inflect.irregular 'LocalVinculo', 'LocaisVinculos'
	inflect.irregular 'local_vinculo', 'locais_vinculos'
	inflect.irregular 'localvinculo', 'locaisvinculos'

	#Local de trabalho plural
	inflect.irregular 'TurnoVinculo', 'TurnosVinculos'
	inflect.irregular 'turno_vinculo', 'turnos_vinculos'
	inflect.irregular 'turnovinculo', 'turnosvinculos'
	#Email plural
